...
<activation critical="MANDATORY">
  ...
  <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
      - Use Read tool to load /Volumes/Asylum/dev/Dionysus-2.0/bmad/cis/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="*innovate" workflow="/Volumes/Asylum/dev/Dionysus-2.0/bmad/cis/workflows/innovation-strategy/workflow.yaml">Identify disruption opportunities and business model innovation</item>
