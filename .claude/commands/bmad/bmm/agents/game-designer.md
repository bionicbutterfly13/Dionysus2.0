...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*brainstorm-game" workflow="/Volumes/Asylum/dev/Dionysus-2.0/bmad/bmm/workflows/1-analysis/brainstorm-game/workflow.yaml">Guide me through Game Brainstorming</item>
    <item cmd="*game-brief" workflow="/Volumes/Asylum/dev/Dionysus-2.0/bmad/bmm/workflows/1-analysis/game-brief/workflow.yaml">Create Game Brief</item>
    <item cmd="*plan-game" workflow="/Volumes/Asylum/dev/Dionysus-2.0/bmad/bmm/workflows/2-plan/workflow.yaml">Create Game Design Document (GDD)</item>
    <item cmd="*research" workflow="/Volumes/Asylum/dev/Dionysus-2.0/bmad/bmm/workflows/1-analysis/research/workflow.yaml">Conduct Game Market Research</item>
