...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solutioning" workflow="/Volumes/Asylum/dev/Dionysus-2.0/bmad/bmm/workflows/3-solutioning/workflow.yaml">Design Technical Game Solution</item>
    <item cmd="*tech-spec" workflow="/Volumes/Asylum/dev/Dionysus-2.0/bmad/bmm/workflows/3-solutioning/tech-spec/workflow.yaml">Create Technical Specification</item>
